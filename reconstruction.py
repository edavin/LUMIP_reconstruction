...
for scen in scenarios:
    ...
    for season in seasons:
        ...
        path_file = out_dir+"TSrec_"+scen+"_B17_"+season+"_850-2014.nc"
        print(path_file)
        ...
        #B17_missing.to_dataset(name='TS_missing').to_netcdf(path=path_file,mode='a')

        path_file = out_dir+"TSrec_"+scen+"_D18_"+season+"_850-2014.nc"
        print(path_file)
        TSrec_D18.to_dataset(name='TSrec').to_netcdf(path=path_file, unlimited_dims={'time':True})
        #D18_missing.to_dataset(name='TS_missing').to_netcdf(path=path_file,mode='a')
